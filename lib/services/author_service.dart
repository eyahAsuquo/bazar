...
class AuthorService {
  final List<Author> _authors = [
    Author(
      ...
      book: books
          .where(
              (author) => author.authorName.toLowerCase().contains("rowling"))
          .toList(),
    ),
    Author(
        name: "Louise Penny",
        image: "assets/img/ocqgk5-b88776772z.120160830102641000ghlier5k.10.jpg",
        genre: "Writer",
        description:
        ...
        book: books
            .where(
                (author) => author.authorName.toLowerCase().contains("penny"))
            .toList()),
    Author(
        name: "Liane Moriartv",
    ...
    Author(
        ...
        book: books
            .where(
                (author) => author.authorName.toLowerCase().contains("hawkins"))
            .toList()),
  ];
