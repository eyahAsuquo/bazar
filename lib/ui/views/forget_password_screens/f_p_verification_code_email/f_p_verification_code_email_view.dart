...
import 'f_p_verification_code_email_viewmodel.dart';

class FPVerificationCodeEmailView
    extends StackedView<FPVerificationCodeEmailViewModel> {
  const FPVerificationCodeEmailView({Key? key}) : super(key: key);

  @override
  Widget builder(
    BuildContext context,
    FPVerificationCodeEmailViewModel viewModel,
    Widget? child,
  ) {
    return Scaffold(
      appBar: AppBar(),
  ...
  @override
  FPVerificationCodeEmailViewModel viewModelBuilder(
    BuildContext context,
  ) =>
      FPVerificationCodeEmailViewModel();
}
